...
public class Day04Test {
    ...
    public static String firstBasicResult = "13";
    public static String secondBasicResult = "30";

    @Test
    public void firstBasicCase() throws IOException {
        String actualResult = Day04.getFirstPuzzleResult(firstBasicInput);
        assertEquals(firstBasicResult, actualResult);
    }

    @Test
    public void secondBasicCase() throws IOException {
        String actualResult = Day04.getSecondPuzzleResult(secondBasicInput);
